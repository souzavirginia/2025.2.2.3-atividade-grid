...
### 6. Entrega
- [x] Testar página em diferentes navegadores
- [x] Verificar responsividade em dispositivos reais ou usar F12 no navegador
- [x] Fazer commit no repositório Git
